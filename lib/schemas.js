...
let Schemas = class Schemas {
    constructor(options = {}) {
        ...
        this.validator.compile(require('./schemas/ship').default);
        this.validator.compile(require('./schemas/game_turn').default);
    }
    ...
    validate(schema, value, stack) {
        ...
        return _asyncToGenerator(function* () {
            try {
                ...
                debug("schema errors: %O\ndocument: %O", validate.errors, value);
            } catch (e) {
                throw e;
            }
        })();
