...
describe('relative_coords', () => {
    ...
    [{ coords: [0, 10], e: { angle: 0, bearing: -1, target_angle: 6, target_bearing: 1 } }, { coords: [0, -10], e: { angle: 6, bearing: 5, target_angle: 0, target_bearing: -5 } }, { coords: [10, 0], e: { angle: 3, bearing: 2, target_angle: -3, target_bearing: 4 } }].forEach(({ coords, e }) => {
...
test('basic', () => {
    ...
    let result = (0, _index.fire_weapon)(attacker, target, { type: 'beam', class: 1, arcs: ['FS'] });
...
test('bug w/ Front', () => {
    ...
    (0, _dice.rig_dice)([6, 6, 1]);
    let result = (0, _index.fire_weapon)(attacker, target, { type: 'beam', class: 1, arcs: ['F'] });
...
test('beam-2', () => {
    ...
    let result = (0, _index.fire_weapon)(attacker, target, { type: 'beam', class: 2, arcs: ['F'] });
