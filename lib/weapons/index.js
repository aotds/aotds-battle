...
function fire_weapon(attacker, target, weapon) {
  ...
  if (!target) {
    ...
    return _result = result, (0, _updeep2.default)({
      aborted: 'no target'
    })(_result);
  }
  ...
  if (!weapon) {
    ...
    return _result2 = result, (0, _updeep2.default)({
      aborted: 'no weapon'
    })(_result2);
  }
  ...
  penetrating_damage_dice = (0, _dice.roll_dice)(damage_dice.filter(x => x == 6).length, {
    reroll: [6]
  });
  ...
  result = (0, _updeep2.default)(_fp2.default.pickBy(v => v.length)({
    damage_dice,
