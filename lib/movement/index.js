...
//     bank: 'integer',
// }
function plot_movement(ship, orders = null) {
  let navigation = ship.navigation;

  if (!orders) {
    orders = _lodash2.default.get(ship, 'orders.navigation', {});
  }
  ...
  })(navigation); //    navigation = move_thrust( navigation, navigation.velocity );
