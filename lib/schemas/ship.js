...
const maneuver_range = _jsonSchemaShorthand.add_definition.call(definitions, 'maneuver_range', "range of values for the maneuver (for the ui)", (0, _jsonSchemaShorthand.array)('number'), { nbrItems: 2 });
...
navigation = _extends({}, navigation, { course: navigation });
...
const orders = _jsonSchemaShorthand.add_definition.call(definitions, 'orders', (0, _jsonSchemaShorthand.object)({
    ...
    weapons: (0, _jsonSchemaShorthand.array)((0, _jsonSchemaShorthand.object)({
        weapon_id: 'integer',
        firecon_id: 'integer'
    }))
