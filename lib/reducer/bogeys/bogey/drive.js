...
reaction.INTERNAL_DAMAGE = action => state => {
  ...
  return _fp2.default.pipe([(0, _updeep2.default)({
    damage_level: l => _fp2.default.isNil(l) ? 1 : l + 1
  }), _updeep2.default.if(({
    damage_level
  }) => damage_level === 1, s => _extends({}, s, {
    current: parseInt(s.rating / 2)
  })), _updeep2.default.if(({
    damage_level
  }) => damage_level === 2, (0, _updeep2.default)({
    current: 0
  }))])(state);
  return state;
};
