...
const maneuver_range = _jsonSchemaShorthand.add_definition.call(definitions, 'maneuver_range', "range of values for the maneuver", (0, _jsonSchemaShorthand.array)('number'), {
  nbrItems: 2
});
